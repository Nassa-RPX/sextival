...
export const Card = (
  ...
  <motion.div
    className="absolute left-0 bottom-0 right-0 top-0 rounded-md text-sex-dblue text-2xl lg:text-3xl font-bold bg-[#fadce1] "
    drag="x"
  ...
  >
    <div className="px-8 py-4 w-full h-full max-h-[400px] flex flex-col pointer-events-none items-center gap-4 relative">
      ...
      />
      <div className="absolute w-full h-[60px] flex items-center justify-center px-2 text-center leading-none bg-[#fadce1] rounded-b-md bottom-0">
        {card.name}
      </div>
    </div>
  </motion.div>
