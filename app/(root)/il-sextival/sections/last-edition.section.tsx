...
export const LastEdition = () => (
  <section className="flex flex-col gap-2 text-lg lg:text-xl lg:w-4/5">
    ...
    <p>
      ...
      Nazioni Unite: l&apos;
      <strong>Organizzazione Mondiale della Sanità</strong> (OMS).
    </p>
    ...
    <p>
      ...
      questo vogliamo lottare affinché l&apos;<i>educazione sessuale</i> si
      tramuti in un diritto garantito alle persone cittadine di qualsiasi paese.
    </p>
  </section>
);
